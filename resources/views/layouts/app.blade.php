                ...
                <div class="col-lg-4">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <a href="{{route('home')}}" class="list-group-item-action">
                            Home
                            </a>
                        </li>
                        ...
                        <li class="list-group-item">
                            <a href="{{route('posts.trashed')}}" class="list-group-item-action">
                                Trashed Posts
                            </a>
                        </li>
                        <li class="list-group-item">
                            <a href="{{route('categories.create')}}" class="list-group-item-action">
                                Create New Categories
                            </a>
                        </li>
                        <li class="list-group-item">
                            <a href="{{route('categories.index')}}" class="list-group-item-action">
                                All Categories
                            </a>
                        </li>
